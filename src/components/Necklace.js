   ...
   var oldItems = JSON.parse(localStorage.getItem('itemsArray')) || [];
    ...
    return(
        <Fragment >
          ...
          {
            (necklace !=null&&necklace!=[]) ?(Object.entries(necklace).map(([key,value])=>(
              <>
              {
                isDesktopOrLaptop &&
                <>
              ...
              <Row>
                  <Col className="md-6">
                  <img src={value.picture} onClick={()=>{twoImages(value)}} style={{width:"200px",height:"200px"}} class="card-img-top" alt="..."/>
                  </Col>
                  <Col className="md-6">
                  <div class="card-body" >
                  <div>
