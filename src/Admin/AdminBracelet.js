  ...
  const imagePickerr = async e => {
    ...
    const imagePicker = async e => {
      ...
      const addItem =  () => {
        ...
        try {
          firebase.database().ref("bracelets/"+v4()).set(
            {
   ...
   const deleteItem=(id)=>{
     ...
     .catch((err)=>console.log(err))
      ...
      return(
          ...
          <Fragment>
          {
            (bracelet!=null) ?(Object.entries(bracelet).map(([key,value])=>(
